...
public class Pathfinder {
	...
	private boolean isOpen(PointBFS self, Point check, int[][] map){
		if (q!=null) {
...
//		}
	...
	private boolean isOpen(PointBFS start, Direction dir, int[][] map) {
		Point check = Direction.translate(start.point, dir);
		return isOpen(start,check,map);
	}
}
